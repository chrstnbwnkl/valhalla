...
TEST(BlindUserMode, Bridge) {
  ...
  auto map = gurka::buildtiles(layout, ways, {}, {}, "test/data/blind_user_mode_bridge");
...
TEST(BlindUserMode, Tunnel) {
  ...
  const auto layout = gurka::detail::map_to_coordinates(ascii_map, 50);
  auto map = gurka::buildtiles(layout, ways, {}, {}, "test/data/blind_user_mode_tunnel");
  auto result = gurka::do_action(valhalla::Options::route, map, {"A", "D"}, "pedestrian",
                                 {{"/costing_options/pedestrian/type", "blind"}});
...
TEST(BlindUserMode, TrafficSign) {
  ...
  const auto layout = gurka::detail::map_to_coordinates(ascii_map, 50);
  auto map = gurka::buildtiles(layout, ways, nodes, {}, "test/data/blind_user_mode_traffic_sign");
  auto result = gurka::do_action(valhalla::Options::route, map, {"A", "D"}, "pedestrian",
                                 {{"/costing_options/pedestrian/type", "blind"}});
...
TEST(BlindUserMode, Bollard) {
  ...
  const auto layout = gurka::detail::map_to_coordinates(ascii_map, 50);
  auto map = gurka::buildtiles(layout, ways, nodes, {}, "test/data/blind_user_mode_bollard");
  auto result = gurka::do_action(valhalla::Options::route, map, {"A", "D"}, "pedestrian",
                                 {{"/costing_options/pedestrian/type", "blind"}});
